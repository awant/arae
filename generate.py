...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='model.pt', help='path to .pt checkpoint')
...
def main(args):
    ...
    sentences = generate_sentences(autoencoder, generator, dictionary, args.count, args.maxlen)
